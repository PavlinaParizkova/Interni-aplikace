    ...
    <>
      ...
      <main style={{ maxWidth: 1100, margin: "0 auto", padding: "72px clamp(1rem, 4vw, 3rem) 6rem" }}>
        ...
        {/* ═══════════════════════════════════════════════════════════════════
            AERO FN SALES SYNC
        ═══════════════════════════════════════════════════════════════════ */}
        <section id="sales-sync" style={{ paddingTop: "4rem", paddingBottom: "4rem" }}>
          <p style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.22em", textTransform: "uppercase", color: "var(--color-at-white)", marginBottom: "0.75rem" }}>
            {t.sections.s11.label}
          </p>
          ...
          {/* Účastníci */}
          <div style={{ marginBottom: "2.5rem" }}>
            <p style={{ fontSize: "0.7rem", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "var(--color-at-white)", marginBottom: "0.75rem" }}>
              {t.aeroSync.participantsLabel}
            </p>
            <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
              {t.aeroSync.participants.map((p) => (
                <span key={p} style={{ padding: "4px 12px", borderRadius: 5, fontSize: "0.8rem", fontWeight: 500, background: "var(--color-at-blue-v2)", border: "1px solid var(--color-at-blue-v3)", color: "var(--color-at-blue-v5)" }}>
                  {p}
                </span>
              ))}
            </div>
          ...
          {/* Hlavní závěry */}
          <p style={{ fontSize: "0.7rem", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "var(--color-at-white)", marginBottom: "1rem" }}>
            {t.aeroSync.conclusionsLabel}
          </p>
          <div className="grid-auto grid-auto-md" style={{ marginBottom: "2.5rem" }}>
            {t.aeroSync.conclusions.map((item) => (
              <div key={item.title} className="card" style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                <div style={{ display: "flex", alignItems: "flex-start", gap: 8 }}>
                  <div style={{ width: 3, height: 14, borderRadius: 2, background: "var(--color-at-red)", flexShrink: 0, marginTop: 4 }} />
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "2rem", marginBottom: "2.5rem" }}>
            ...
            <div className="card" style={{ background: "var(--color-at-blue-v2)", borderColor: "var(--color-at-blue-v3)" }}>
              <p style={{ fontSize: "0.7rem", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "var(--color-at-white)", marginBottom: "1rem" }}>
                {t.aeroSync.decisionsLabel}
              </p>
              <div style={{ display: "flex", flexDirection: "column", gap: "0.625rem" }}>
                {t.aeroSync.decisions.map((d) => (
                  <div key={d} style={{ display: "flex", alignItems: "flex-start", gap: 8 }}>
                    <div style={{ width: 5, height: 5, borderRadius: "50%", background: "var(--color-at-red)", flexShrink: 0, marginTop: 7 }} />
                    <span style={{ fontSize: "0.875rem", color: "var(--color-at-blue-a5)", lineHeight: 1.6 }}>{d}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="card" style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", gap: "1rem" }}>
              <div>
                <p style={{ fontSize: "0.7rem", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "var(--color-at-blue-v4)", marginBottom: "0.5rem" }}>
                  {t.aeroSync.fathomLabel}
                </p>
                <p style={{ fontSize: "0.875rem", color: "var(--color-at-blue-v5)", lineHeight: 1.6, margin: 0 }}>
                  Fathom · {t.aeroSync.date}
                </p>
              </div>
              <a
                href={t.aeroSync.fathomLink}
                target="_blank"
                rel="noopener noreferrer"
                style={{
                  display: "inline-flex",
                ...
                onMouseEnter={(e) => {
                  (e.currentTarget as HTMLAnchorElement).style.background = "var(--color-at-blue-v3)";
                  (e.currentTarget as HTMLAnchorElement).style.color = "var(--color-at-white)";
                }}
                onMouseLeave={(e) => {
                  (e.currentTarget as HTMLAnchorElement).style.background = "var(--color-at-blue-v2)";
                  (e.currentTarget as HTMLAnchorElement).style.color = "var(--color-at-blue-a5)";
                }}
              >
                ▶ {t.aeroSync.fathomLabel}
              </a>
          ...
          {/* Action Items tabulka */}
          <p style={{ fontSize: "0.7rem", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "var(--color-at-white)", marginBottom: "0.75rem" }}>
            {t.aeroSync.actionsLabel}
          </p>
          <div style={{ overflowX: "auto" }}>
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.875rem" }}>
              <thead>
                <tr>
                  {t.aeroSync.actionsHeaders.map((h, i) => (
                    <th
                      key={i}
                      style={{
                        ...
                        background: "var(--color-at-blue-v2)",
                        borderBottom: "2px solid var(--color-at-blue-v3)",
                        borderRight: i === 0 ? "1px solid var(--color-at-blue-v3)" : "none",
                        whiteSpace: "nowrap",
                        width: i === 0 ? "160px" : "auto",
                      }}
                    >
                      {h}
                    </th>
              ...
              <tbody>
                {t.aeroSync.actions.map((row, ri) => (
                  <tr key={ri} style={{ background: ri % 2 === 0 ? "var(--color-at-blue-v1)" : "transparent" }}>
                    <td style={{ padding: "0.75rem 1rem", fontWeight: 700, fontSize: "0.75rem", letterSpacing: "0.06em", color: "var(--color-at-blue-v4)", borderBottom: "1px solid var(--color-at-blue-v2)", borderRight: "1px solid var(--color-at-blue-v2)", whiteSpace: "nowrap" }}>
                      {row.owner}
                    </td>
                    <td style={{ padding: "0.75rem 1rem", color: "var(--color-at-blue-v5)", lineHeight: 1.55, borderBottom: "1px solid var(--color-at-blue-v2)" }}>
                      {row.task}
                    </td>
                  </tr>
                ))}
